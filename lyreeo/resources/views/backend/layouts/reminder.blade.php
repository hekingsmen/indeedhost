<div class="modal fade " id="status_update" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  {{Form::open(array('url'=>route('reminderEmail'), 'class'=>'ajax-submit', 'id'=>'reminderEmail'))}}
      <div class="modal-dialog modal-homepage reminder-modal" role="document">
         <div class="modal-content">
              ...
              <div class="modal-footer">
                  ...
                  <button type="submit" class="btn btn-primary pop-btn" > {!! __('sentence.project_status.send_email') !!} </button>
              </div>
         </div>
     </div>
  {{Form::close()}}
