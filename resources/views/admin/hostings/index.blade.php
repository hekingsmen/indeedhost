          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header card-header-primary">
                <h4 class="card-title ">Hosting Plans</h4>
                <p class="card-category">List of hosting plans</p>
              </div>
              <div class="card-body">
                <div class="table-responsive">
                  <div class="gapMe" >
                  <a href="{{route('admin.hostings.create')}}" class="btn btn-primary float-right">Add New</a>
                  </div>
