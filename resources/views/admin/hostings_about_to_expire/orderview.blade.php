                                ...
                                <div class="media-body my-auto text-right">
                                    <div class="row my-auto flex-column flex-md-row">
                                        ...
                                        <div class="col my-auto">
                                            ...
                                            <button type="button" id="test1" class="btn btn-info btn-sm process" data-id="{{$item->id}}" data-username="{{$item->username}}" data-domain="{{$item->domain}}" data-password="{{$item->password}}" data-massage ="{{$item->massage}}" data-email="{{$item->email}}" data-toggle="modal" data-target="#myModal">Process<div class="ripple-container"></div></button>
                                            @elseif($item->status == 'completed')
                                            <button type="button" id="test1" class="btn btn-basic btn-sm process" data-id="{{$item->id}}" data-username="{{$item->username}}" data-domain="{{$item->domain}}" data-password="{{$item->password}}" data-massage ="{{$item->massage}}" data-email="{{$item->email}}" data-toggle="modal" data-target="#myModal">Completed<div class="ripple-container"></div></button>
                                            @else
                                            @endif
                                        </div>
                                    </div>
                ...
                <div class="col">
                    <div class="row justify-content-between">
                        ...
                        <div class="flex-sm-col text-right col">
                            <p class="mb-1"><b>Plan Price</b></p>
                        </div>
                        <div class="flex-sm-col col-auto">
                            <p class="mb-1">&#8377;{{$item->item_price}}</p>
                        </div>
                    </div>
                    <div class="row justify-content-between">
                        <div class="flex-sm-col text-right col">
            ...
            <div class="jumbotron-fluid">
                <div class="row justify-content-between ">
                    ...
                    <div class="col-auto my-auto ml-auto">
                        <h1 class="display-3 ">&#8377; {{$item->total_price}}</h1>
                    </div>
                </div>
            </div>
        </div>
