...
<body>
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <div class="top-header-content">
                            <a href="#"><i class="fa fa-phone" aria-hidden="true"></i> <span>Call Us: 010-4321-9874</span></a>
                            <a href="#"><i class="fa fa-envelope" aria-hidden="true"></i> <span>Email: skr.illex@nomail.com</span></a>
                        </div>
                    </div>
            ...
            <div class="classy-nav-container breakpoint-off">
                <div class="container">
                    ...
                    <nav class="classy-navbar justify-content-between" id="hamiNav">
                        ...
                        <!-- Logo -->
                        <a class="nav-brand" href="index.html"><img src="{{ asset('ecohost/img/core-img/logo.png') }}" alt=""></a>
    ...
    <footer class="footer-area section-padding-80-0">
		...
		@include('forntend.layouts.footer_bottom')
