                ...
                <form method="POST" action="{{ route('password.update') }}">
                    ...
                    <div class="row child" >
                        <div class="col-12 col-lg-6" style=" margin: 0 auto;" >
                            ...
                            <input id="email" type="email" class="form-control mb-30 @error('email') is-invalid @enderror" name="email" value="{{ $email ?? old('email') }}" required autocomplete="email" autofocus>
                    ...
                    <div class="row child" >
                        <div class="col-12 col-lg-6" style=" margin: 0 auto;" >
                            ...
                            <input id="password" type="password" class="form-control mb-30 @error('password') is-invalid @enderror" name="password" required autocomplete="new-password">
                    ...
                    <div class="row child" >
                        <div class="col-12 col-lg-6" style=" margin: 0 auto;" >
                            ...
                            <input id="password-confirm" type="password" class="form-control mb-30" name="password_confirmation" required autocomplete="new-password">
                        </div>
                    </div>
                    ...
                    <div class="row child" style="text-align: end;" >
                        <div class="col-12 col-lg-6 child " style=" margin: 0 auto;" >
                            <div class="col-12">
                                <button type="submit" class="btn hami-btn btn-3 mt-15">{{ __('Reset Password') }}</button>
                            </div>
                        </div>
                    </div>
